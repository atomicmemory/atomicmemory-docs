...
| Embedding providers | openai, openai-compatible, ollama, transformers (local WASM) | Multi-provider | Multi-provider | Multi-provider |
...
- **Pluggable providers** — embeddings via openai, openai-compatible, ollama, or transformers (local WASM); LLM via openai, openai-compatible, ollama, anthropic, google, or groq ([providers](/platform/providers))
