...
From [`atomicmemory-core/src/services/embedding.ts:69-72`](https://github.com/atomicmemory/atomicmemory-core/blob/main/src/services/embedding.ts#L69-L72):
...
Two methods. One for single embeddings, one for batch. Every backend —
OpenAI REST, Ollama's native API, local WASM via transformers.js, any
OpenAI-compatible endpoint — satisfies exactly this shape.
...
From [`embedding.ts:232-254`](https://github.com/atomicmemory/atomicmemory-core/blob/main/src/services/embedding.ts#L232-L254):
...
4. Wire any required API keys into `RuntimeConfig`.
...
root. From [`embedding.ts:51-56`](https://github.com/atomicmemory/atomicmemory-core/blob/main/src/services/embedding.ts#L51-L56):
